...
export function Control(props: InputControlProps) {
    return (
        <input className="flex-1 outline-none border-none bg-transparent p-0 text-zinc-900 placeholder-zinc-600 dark:placeholder-zinc-300 dark:text-zinc-200" {...props} />
    )
}
