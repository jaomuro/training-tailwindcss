...
export function FileItem({name, size, state = 'error'} : FileItemProps) {
    ...
    return (
        ...
        className={container()}>
            ...
            {state === 'error' ? (
                ...
                <button type="button" className="text-sm font-semibold text-error-700">Try again</button>
                ...
                <div className="flex w-full items-center gap-3">
                    <div className="h-2 flex-1 rounded-full bg-zinc-100">
                        <div className="h-2 bg-violet-600 rounded-full" style={{width: state === 'complete' ? '100%' : '80%'}}></div>
                    </div>
